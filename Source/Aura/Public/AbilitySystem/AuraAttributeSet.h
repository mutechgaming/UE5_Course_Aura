...
private:
	...
	void HandleIncomingDamage(FEffectProperties Props); // ep. 310

	void HandleIncomingXP(FEffectProperties Props); // ep. 310

	void Debuff(FEffectProperties Props); // ep. 310
